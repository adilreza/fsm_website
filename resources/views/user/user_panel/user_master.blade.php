...
<head>
  ...
  <link href="{{URL::asset('fsm_user/vendor/datatables/dataTables.bootstrap4.css')}}" rel="stylesheet">

  <!-- Custom styles for this template-->
  <link href="{{URL::asset('fsm_user/css/sb-admin.css')}}" rel="stylesheet">
...
<body id="page-top">
  ...
  <a class="navbar-brand mr-1" href="index.html">{{session('user_name')}}</a>
    ...
    <div id="content-wrapper">
      ...
      <footer class="sticky-footer">
        <div class="container my-auto">
          ...
          <span>Copyright © <a href="{{URL::to('/')}}">frontier-semiconductor</a> 2019</span>
          </div>
        </div>
      </footer>
  ...
  <script src="{{URL::asset('fsm_user/vendor/jquery/jquery.min.js')}}"></script>
  <script src="{{URL::asset('fsm_user/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
  ...
  <script src="{{URL::asset('fsm_user/js/sb-admin.min.js')}}"></script>
