        ...
        <div class="container-fluid" style="background:white;">
                ...
                <div class="card border-default" style="background:white;">
                        <div class="card-header bg-default">
                         <h3 style="color:black;">FSM published Presentation</h3>
                        </div>
                            ...
                            <div class="row ">
                                @foreach ($all_presentation as $presentation)
                                    <div class="col-md-11 mr-2 ml-3 mt-3 mb-1" style="background:#f1f2f6; padding:20px; border-radius:10px;">
                                       <h4 style="color:black;"> {{str_limit($presentation->p_title, 70)}}</h4>
                                        ...
                                        <hr>
                                    <button calss="btn bg-primary " id="preview" ><a href="{{URL::to('fsm_client/fsm_presentation_details/'.$presentation->id)}}">details</a></button>
