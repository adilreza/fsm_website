        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-xl-8">
                <div class="blog_box_wrapper blog_box_padding posts">
                    <div class="blog_img_wraper blog_img_wraper_2 text-center" > <img style="height:450px;width:350px;" src="{{URL::asset('fsm_all_web_file/fsm_image_gallery/allproducts/fsm_product_413_SA.png')}}" alt=""> </div>
                    ...
                    <div>
                        ...
                        <div id="specific" class="tabcontent">
                            ...
                            <div style="margin-left:20px;" id="listdetails">
                                <ul type="square">
                                    <li>FSM 413SA (SP) 300 MM SEMI-AUTOMATED WAFER SUBSTRATE THICKNESS
                                        MAPPER SYSTEM, SINGLE PROBE</li>
