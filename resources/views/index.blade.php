  ...
  <div class="container-fluid">
    <div class="row">
      <div class="sb-nivo-slider-wrapper kc-elm kc-css-242493">
        ...
        <img  src="{{ URL::asset('fsm_all_web_file/fsm_image_gallery/slider/background_fsm_image.png')}}" alt="" title="#htmlcaption1_30"/>
		<img src="{{ URL::asset('fsm_all_web_file/fsm_image_gallery/slider/background_fsm_image.png')}}" alt="" title="#htmlcaption1_28" /> </div>
      ...
      jQuery(document).ready(function () {
        ...
        jQuery('#vmap').vectorMap({
          ...
          onRegionClick: function(event, code, region)
          {
            ...
            {
              $('#name').html(region+"("+code+")"+newline+newline+line+"<h1 style='color:red;'>NO Branch In this Country</h1>");
